                                            ...
                                            <div className="form-inner">
                                                <fieldset>
                                                    ...
                                                    <dl id="sample" className="dropdown">
                                                        <dt>
                                                            <Link href="#" className="nolink"><span><img className="flag" src="/assets/images/common/vietnam.png" alt="" />Vietnamese</span></Link>
                                                        ...
                                                        <dd>
                                                            <ul className="option">
                                                                <li><Link href="#" className="nolink"><img className="flag" src="/assets/images/common/vietnam.png" alt="" />Vietnamese</Link></li>
                                                                <li><Link href="#" className="nolink"><img className="flag" src="http://www.jankoatwarpspeed.com/wp-content/uploads/examples/reinventing-drop-down/fr.png" alt="" />France </Link></li>
                                                            </ul>
                                                        </dd>
                                                    </dl>
                                                </fieldset>
